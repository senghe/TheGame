...
final class FleetHasReachedJourneyReturnPointEventSpec extends ObjectBehavior
{
    ...
    public function it_has_start_galaxy_point(): void
    {
        $this->getStartGalaxyPoint()->shouldReturn("[1:2:3]");
    }
