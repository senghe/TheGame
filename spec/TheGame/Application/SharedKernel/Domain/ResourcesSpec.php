...
final class ResourcesSpec extends ObjectBehavior
{
    ...
    public function it_returns_resources_amount(): void
    {

    }

    public function it_returns_object_from_scalar_array(): void
    {

    }

    public function it_throws_exception_when_resolving_object_from_scalar_array_but_has_incorrect_key_type(): void
    {

    }

    public function it_throws_exception_when_resolving_object_from_scalar_array_but_has_incorrect_value_type(): void
    {
