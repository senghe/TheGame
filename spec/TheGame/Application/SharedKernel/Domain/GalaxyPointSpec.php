...
final class GalaxyPointSpec extends ObjectBehavior
{
    ...
    public function it_throws_exception_when_resolved_array_has_different_count_than_three(): void
    {

    }

    public function it_throws_exception_when_resolved_array_children_are_not_integers(): void
    {
